...
class TestViewer:
    ...
    @prepare_test
    def test_disable_context_menu(self, window: Viewer) -> None:
        """
    ...
    @prepare_test
    def test_export_ivc(self, window: Viewer) -> None:
        """
        Test
        :param window: viewer widget.
        """
        ...
        curve = window.plot.add_curve("test")
        ...
        with open(os.path.join(dir_to_export, file_name), "r") as file:
            content = file.read()
        assert content == '"test Voltage, V","test Current, A"\n-2.5,-0.005\n2.5,0.005\n'
    ...
    @prepare_test
    def test_remove_center_text(self, window: Viewer) -> None:
        """
    ...
    @prepare_test
    def test_remove_lower_text(self, window: Viewer) -> None:
        """
    ...
    def test_set_axis_titles_in_constructor(self, display_window: bool) -> None:
        """
    ...
    @prepare_test
    def test_set_axis_titles_by_method(self, window: Viewer) -> None:
        """
        Test checks assignment of titles to axes.
        :param window: viewer widget.
        """
    ...
    @prepare_test
    def test_show_center_text(self, window: Viewer) -> None:
        """
    ...
    @prepare_test
    def test_show_center_text_with_user_settings(self, window: Viewer) -> None:
        """
    ...
    @prepare_test
    def test_show_lower_text_with_user_settings(self, window: Viewer) -> None:
        """
