...
class Viewer(QWidget):
    def __init__(self, parent=None, solid_axis_enabled: bool = True, grid_color: QColor = QColor(0, 0, 0),
                 ...
                 axis_sign_enabled: bool = True, axis_font: QFont = DEFAULT_AXIS_FONT,
                 marker_font: QFont = DEFAULT_MARKER_FONT, title_font: QFont = DEFAULT_TITLE_FONT,
        ...
        self._plot = IvcViewer(self, grid_color=grid_color, back_color=back_color,
                               ...
                               axis_sign_enabled=axis_sign_enabled, axis_font=axis_font, marker_font=marker_font,
                               title_font=title_font, screenshot_file_name_base=screenshot_file_name_base)
